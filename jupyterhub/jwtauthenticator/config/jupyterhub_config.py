...
c.JupyterHub.authenticator_class = 'jwtauthenticator.jwtauthenticator.BlendAuthenticator'


c.DummyAuthenticator.password = 'newland'
...
c.Authenticator.admin_users = {'newland', 'admin'}
...
c.KubeSpawner.k8s_api_request_timeout = 20
