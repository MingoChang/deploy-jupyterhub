...
class BlendAuthenticator(JSONWebTokenAuthenticator, MyDummyAuthenticator):
    def get_handlers(self, app):
        handlers = JSONWebTokenAuthenticator.get_handlers(self, app) + MyDummyAuthenticator.get_handlers(self, app)
    ...
    def authenticate(self, handler, data=None):
        ...
        try:
            ...
            authenticator = MyDummyAuthenticator.authenticate(self, handler, data)
