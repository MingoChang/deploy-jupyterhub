...
for key, config_py in sorted(get_config("hub.extraConfig", {}).items()):
    ...
    exec(config_py)
c.JupyterHub.authenticator_class = 'nlaiauthenticator.nlaiauthenticator.NlAiTokenAuthenticator'

c.NlAiTokenAuthenticator.secret = '5020408408b8984b2e25b47e544f3f3943b9f86ddd15d501287ed32a70e3f168'            # The secrect key used to generate the given token

c.NlAiTokenAuthenticator.username_claim_field = 'username'                           # The claim field contianing the username/sAMAccountNAme/userPrincipalName
c.NlAiTokenAuthenticator.auth_url = 'http://52.131.255.229:30001'
c.NlAiTokenAuthenticator.expected_audience = ""
c.NlAiTokenAuthenticator.header_name = 'Authorization'                   # This will enable local user creation upon authentication, requires JSONWebTokenLocalAuthenticator
