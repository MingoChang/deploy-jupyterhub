...
#c.JupyterHub.authenticator_class = 'mysqlauthenticator.mysqlauthenticator.MysqlAuthenticator'
c.JupyterHub.authenticator_class = 'jwtauthenticator.jwtauthenticator.JSONWebTokenAuthenticator'
c.DummyAuthenticator.password = '8800'
c.ResourceUseDisplay.track_cpu_percent = True
c.JSONWebTokenAuthenticator.secret = '5020408408b8984b2e25b47e544f3f3943b9f86ddd15d501287ed32a70e3f168'            # The secrect key used to generate the given token
...
c.JSONWebTokenAuthenticator.timestamp_claim_field = 'timestamp'                           # The claim field contianing the timestamp
c.JSONWebTokenAuthenticator.param_name ='auth_token'
c.JSONWebTokenAuthenticator.param_timeout = '60'
c.JSONWebLocalTokenAuthenticator.create_system_users = False                       # This will enable local user creation upon authentication, requires JSONWebTokenLocalAuthenticator
c.Authenticator.admin_users = {'admin', 'admin'}
c.LocalAuthenticator.create_system_users = False
c.KubeSpawner.privileged = True
c.JupyterHub.redirect_to_server = True

# c.JupyterHub.concurrent_spawn_limit = 300
# c.KubeSpawner.start_timeout = 1000
# c.KubeSpawner.k8s_api_request_timeout = 6
# c.KubeSpawner.k8s_api_request_retry_timeout = 90
# c.KubeSpawner.events_enabled = True
# c.KubeSpawner.k8s_api_threadpool_workers = 300
